...
def split_periods_into_pairs(periods_data: GssPmpIndexType) -> Dict[str, Dict[int, dict]]:
    """
...
async def pmp_gss_split_pairs(
    ...
    split_pmp = split_periods_into_pairs(pmp_periods)
    split_gss = split_periods_into_pairs(gss_periods)
    
    return {
        'pmp_periods': split_pmp,
        'gss_periods': split_gss
    }